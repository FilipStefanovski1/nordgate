...
const stages = [
  {
    ...
    description: "Understand the market, the competition and where genuine opportunity exists.",
  },
  {
    index: "02",
  ...
  {
    index: "03",
    title: "Define the route to market",
    description: "Set the positioning, target segments and sequencing that make sense for you.",
  },
  {
    index: "04",
    title: "Identify companies and partners",
    description: "Build a concrete list of the accounts and partners worth approaching first.",
  },
  {
    index: "05",
    title: "Start conversations",
    description: "Open real dialogue with the market and refine the approach as we learn.",
  },
];
