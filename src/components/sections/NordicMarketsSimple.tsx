      ...
      <Container>
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-16">
          <div>
            ...
            <h2 className="mt-4 text-balance font-serif text-3xl font-medium tracking-tight text-ink-900 sm:text-4xl">
          ...
          <div className="flex flex-col divide-y divide-border-strong/60 lg:pl-4">
